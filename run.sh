...
if [[ $* == *"--with-obstacles"* ]]
	then
		...
		xterm -geometry 100x30 -bg '#300924' -fg white \
		-e './run_in_terminal_window.sh ArduCopter sitl/bin/arducopter -S --model + --speedup 1 --slave 0 --serial5=tcp:5765:wait --serial6=tcp:5766:wait --serial7=tcp:5767:wait --defaults copter.parm --sim-address=127.0.0.1 --home=46.6143886,142.8119468,69.20,0 -I0' & disown
fi
cd ../mavproxy
